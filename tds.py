...
fivex=white+'['+blue+'NVBTDS'+white+']'
fivex_no_pro=whitex+'[NVBTDS]'+end
hln=white+"["+blue+"NGUYỄN VIỆT BÁCH"+white+"]"
def logo():
    log="""               \033[7;37m\033[1;37m NGUYỄN VIỆT BÁCH [NVBTDS] \033[0m \n               \033[4;40;97m\033[1;97m 1  5  1  2  2  0  0  8 \033[0m \n               \033[4;40;96m\033[1;96m MoMo  :  \033[1;97m0353708694 \033[0m \n               \033[4;40;97m\033[1;97m Z A L O  :  \033[1;96m0989231486 \033[0m \n               \033[7;37m\033[1;37m T O O L  :  TDS PYTHON \033[0m \n \n"""
    os.system('clear')
    for h in log:
       sys.stdout.write(h)
       sys.stdout.flush()
...
for dvt in range(3,0,-1):
        print(blue+'[NVBTDS]',white+'['+blue+str(dvt)+white+']',end='\r')
        sleep(0.7)
logo()
while(True):
